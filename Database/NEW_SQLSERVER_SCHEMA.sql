...
-- --------------------------------------------------
-- Date Created: 04/07/2018 22:24:57
-- Generated from EDMX file: C:\Users\trann\Desktop\mvc-ban-hang\WebBanHang\Models\Ecommerce.edmx
-- --------------------------------------------------
...
IF OBJECT_ID(N'[dbo].[FK_Comment_Customers]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[Comment] DROP CONSTRAINT [FK_Comment_Customers];
GO
IF OBJECT_ID(N'[dbo].[FK_Comment_Products]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[Comment] DROP CONSTRAINT [FK_Comment_Products];
GO
IF OBJECT_ID(N'[dbo].[FK_Contact_Customers]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[Contact] DROP CONSTRAINT [FK_Contact_Customers];
GO
...
IF OBJECT_ID(N'[dbo].[FK_ExcludeCoupon_Coupon]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[ExcludeCoupon] DROP CONSTRAINT [FK_ExcludeCoupon_Coupon];
GO
IF OBJECT_ID(N'[dbo].[FK_ExcludeCoupon_GroupProducts]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[ExcludeCoupon] DROP CONSTRAINT [FK_ExcludeCoupon_GroupProducts];
GO
...
IF OBJECT_ID(N'[dbo].[FK_Options_OptionGroups]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[Attribute] DROP CONSTRAINT [FK_Options_OptionGroups];
GO
...
IF OBJECT_ID(N'[dbo].[FK_ProductOptions_Options]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[ProductAttribute] DROP CONSTRAINT [FK_ProductOptions_Options];
GO
IF OBJECT_ID(N'[dbo].[FK_ProductOptions_Products]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[ProductAttribute] DROP CONSTRAINT [FK_ProductOptions_Products];
GO
...
IF OBJECT_ID(N'[dbo].[FK_Ward_Districts]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[Ward] DROP CONSTRAINT [FK_Ward_Districts];
GO
...
IF OBJECT_ID(N'[dbo].[Advertise]', 'U') IS NOT NULL
...
GO
IF OBJECT_ID(N'[dbo].[ExcludeCoupon]', 'U') IS NOT NULL
    DROP TABLE [dbo].[ExcludeCoupon];
GO
...
GO
IF OBJECT_ID(N'[dbo].[ProductAttribute]', 'U') IS NOT NULL
